  ...
  const uploadFile = (file, signedRequest, url) => {
    ...
    return(
        ...
        <h2>Create a Memory!</h2>
          ...
          <div className='form-input-box'>
            <p>Image URL:</p>
            <input placeholder='Enter URL here or upload a file below'value={image} onChange={(e)=>setImage(e.target.value)}
              maxLength='250'
            />
                    <Dropzone
          ...
          <div className='form-text-box'>
            <p>Content:</p>
            <textarea placeholder='Jot down a few thoughts or comments about this memory'value={content} onChange={(e)=>setContent(e.target.value)}
              maxLength='500'
            />
          </div>
